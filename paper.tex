...
every cluster head are stranded and their packets counted as lost. The
...
\For{$t = 1, 2, \ldots, T$}{
    ...
    \For{each member $s_i \notin \mathcal{C}(t)$}{
        ...
        Transmit $M_{\mathrm{eff},i}(t)$ packets to CH,
...
\begin{itemize}
    ...
    amplitude energy model. Burst size is fixed at $M = 10$ throughout,
